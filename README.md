...
[[images/InstallIntellijLspPlugin.png]]
* After restarting the IDE, configure the plugin
[[images/ConfigureIntellijLspPlugin.png]]
...
* when you now open the model file, the langauge server will be started automatically:
[[images/LspEditor_Error.png]]
